...
function Attiributes() {
    ...
    const updateAttributeValueRequest = usePutRequest({
        url: attributeValueUpdate.replace('id', attributeValue.parent_id),
    })
    ...
    function panelExtra(attribute, isValue) {
        return (
            <Space>
                <Button onClick={() => editBtnHandler(attribute, isValue)}>
                    Edit
                </Button>
                <Button
                    danger
    ...
    return (
        <>
            ...
            <Modal
                title='Attributeni o`chirishni xohlaysizmi?'
